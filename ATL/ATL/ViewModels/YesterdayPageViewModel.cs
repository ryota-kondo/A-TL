...
{
    public class YesterdayPageViewModel : BindableBase
    {
        ...
        public YesterdayPageViewModel(IAllPageModel model, INavigationService navigationService)
        {
            this._model = model;
        ...
        private async void SetList()
        {
            try
            {
                ...
                // ---------------------------ここが集計時期ごとに違う
                var t = _model.GetYesterdayLists();
                // ここが集計時期ごとに違う-----------------------------
                ExecuteTimesList = t;
            }
            finally
